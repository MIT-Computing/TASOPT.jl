...
function PayloadRange()
    ...
    # Load default model
    ac = TASOPT.read_aircraft_model(joinpath(TASOPT.__TASOPTroot__, "../example/B736_PRD.toml"))
    ...
    title("Payload Range Diagram: 737-600", fontsize=16, fontweight="bold")
    legend()
