...
ax1.plot(CL_M85, CLH_M85,  label = r'$Ma_{\infty}: 0.85$', linewidth = 2.5,linestyle = 'solid', marker='o', markersize=10, mec = 'black',markeredgewidth=2)
ax1.plot(CL_M83, CLH_M83,  label = r'$Ma_{\infty}: 0.83$', linewidth = 2.5,linestyle = 'solid', marker='p', markersize=10, mec = 'black',markeredgewidth=2)
ax1.plot(CL_M80, CLH_M80,  label = r'$Ma_{\infty}: 0.80$', linewidth = 2.5,linestyle = 'solid', marker='s', markersize=10, mec = 'black',markeredgewidth=2)
ax1.plot(CL_M77, CLH_M77,  label = r'$Ma_{\infty}: 0.77$', linewidth = 2.5,linestyle = 'solid', marker='d', markersize=10, mec = 'black',markeredgewidth=2)
ax1.plot(CL_M75, CLH_M75,  label = r'$Ma_{\infty}: 0.75$', linewidth = 2.5,linestyle = 'solid', marker='>', markersize=10, mec = 'black',markeredgewidth=2)




ax1.set_xlabel(r'$C_L$',fontname="Times New Roman", fontsize = 22)
ax1.set_ylabel(r'$C_{L_{H}}$',fontname="Times New Roman", fontsize = 22)
