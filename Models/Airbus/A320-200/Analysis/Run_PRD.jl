...
function PayloadRange()
    ...
    # Load default model
    ac = TASOPT.read_aircraft_model(joinpath(TASOPT.__TASOPTroot__, "..//Models/Airbus/A320-200/Analysis/A320_input_prd.toml"))
    ...
    title("Payload Range Diagram: A320-200", fontsize=16, fontweight="bold")
    legend()
    ...
    savefig("Plots/A320_200_PRD_wing_fuel.png")
